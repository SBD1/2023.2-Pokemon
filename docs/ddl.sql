...
CREATE TABLE
    TIPO (NOME_TIPO VARCHAR(10) PRIMARY KEY);

CREATE TABLE
    EFEITO (
        NOME_EFEITO VARCHAR(10) PRIMARY KEY,
...
CREATE TABLE
    MOCHILA (
        ...
        CONSTRAINT FK_ITEM_CHAVE FOREIGN KEY (NOME_ITEM) REFERENCES ITEM_CHAVE (NOME_ITEM),
        CONSTRAINT FK_ITEM_COMUM FOREIGN KEY (NOME_ITEM) REFERENCES ITEM_COMUM (NOME_ITEM),
        CONSTRAINT FK_ITEM_TM FOREIGN KEY (NOME_ITEM) REFERENCES TM (NOME_ITEM),
        CONSTRAINT FK_ITEM_POKEBOLA FOREIGN KEY (NOME_ITEM) REFERENCES POKEBOLA (NOME_ITEM),
...
CREATE TABLE
    CATALOGO_POKEMART (
        ...
        CONSTRAINT FK_POKEMART_ID FOREIGN KEY (POKEMART_ID) REFERENCES POKEMART (POKEMART_ID),
        CONSTRAINT FK_ITEM_NOME FOREIGN KEY (ITEM_NOME) REFERENCES MOCHILA (NOME_ITEM)
    );
