...
CREATE TABLE Treinador (
    treinador_id int PRIMARY KEY NOT NULL,
...
CREATE TABLE Efeito(
    efeito_id SMALLINT PRIMARY KEY,
...
CREATE TABLE Tipos(
    tipo_id varchar(10) PRIMARY KEY,
    nome_tipo varchar(10) NOT NULL
);
...
CREATE TABLE Ginasio(
    ...
    CONSTRAINT fk_tipo1 FOREIGN KEY(tipo1) REFERENCES Tipos(tipo_id),
    CONSTRAINT fk_tipo2 FOREIGN KEY(tipo2) REFERENCES Tipos(tipo_id),
...
CREATE TABLE Pokedex(
	...
	CONSTRAINT fk_numero_pokedex FOREIGN KEY(numero_pokedex) REFERENCES Pokemons_Descobertos(numero_pokemon)
);
